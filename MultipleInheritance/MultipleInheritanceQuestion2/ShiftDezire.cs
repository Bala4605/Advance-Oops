...
namespace MultipleInheritanceQuestion2
{
    public class ShiftDezire : Car, IBrand
    {
        ...
        public ShiftDezire(string brandName,string modelName,FuelType fuelType,int numberOfSeats, string color, int tankCapacity, int numberOfKmDriven,int engineNumber,int chasisNumber) : base(fuelType, numberOfSeats, color, tankCapacity, numberOfKmDriven)
        {
